...
const MyVoucherContainer = props => {
  const { userProfile } = props;
  const [{ data, loading, error }, refetch] = useAxios(
    `/purchases?count=1000&page=1&email=${userProfile.email_address}`
  );
      ...
      {toolkitprops => (
        <div className="table-inner-wrap">
          <div className="table-header">
            <h2 className="table-title">Your Vouchers</h2>
...
export default connect(mapStateToProps)(MyVoucherContainer);
